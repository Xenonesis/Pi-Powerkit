...
PROVIDERS = [
    ...
    },
    {
        ...
        "models": [
            {"id": "openrouter/owl-alpha", "name": "Owl Alpha", "reasoning": False, "ctx": 1048576, "out": 262144, "input": ["text"]},
            {"id": "nvidia/nemotron-3-ultra-550b-a55b:free", "name": "Nemotron 3 Ultra 550B", "reasoning": True, "ctx": 1000000, "out": 65536, "input": ["text"]},
            {"id": "nvidia/nemotron-3-super-120b-a12b:free", "name": "Nemotron 3 Super 120B", "reasoning": True, "ctx": 1000000, "out": 262144, "input": ["text"]},
            {"id": "google/gemma-4-26b-a4b-it:free", "name": "Gemma 4 26B", "reasoning": True, "ctx": 262144, "out": 32768, "input": ["text"]},
            {"id": "google/gemma-4-31b-it:free", "name": "Gemma 4 31B", "reasoning": True, "ctx": 262144, "out": 8192, "input": ["text"]},
            {"id": "nvidia/nemotron-3-nano-30b-a3b:free", "name": "Nemotron 3 Nano 30B", "reasoning": True, "ctx": 256000, "out": 8192, "input": ["text"]},
            {"id": "openrouter/free", "name": "Free Models Router", "reasoning": True, "ctx": 200000, "out": 8192, "input": ["text"]},
            {"id": "openai/gpt-oss-120b:free", "name": "GPT-OSS 120B", "reasoning": True, "ctx": 131072, "out": 131072, "input": ["text"]},
            {"id": "liquid/lfm-2.5-1.2b-instruct:free", "name": "LFM2.5 1.2B Instruct", "reasoning": False, "ctx": 32768, "out": 8192, "input": ["text"]},
            {"id": "nex-agi/nex-n2-pro:free", "name": "Nex-N2-Pro", "reasoning": True, "ctx": 262144, "out": 262144, "input": ["text", "image"]},
            {"id": "nvidia/nemotron-nano-12b-v2-vl:free", "name": "Nemotron Nano 12B VL", "reasoning": True, "ctx": 128000, "out": 128000, "input": ["text"]},
        ],
    },
]
