...
export default function (pi: ExtensionAPI) {
  // ponytail: API keys read from environment. Users set CLINE_API_KEY and TOKENROUTER_API_KEY.
  ...
  if (!TOKENROUTER_API_KEY) {
    console.warn("[pi-cline-free] TOKENROUTER_API_KEY not set — `tokenrouter` provider will not be registered");
  } else {
