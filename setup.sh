...
# Prompt for API keys
echo ""
for var in AIHUBMIX_API_KEY ROUTER9_API_KEY XIAOMI_API_KEY DATABRICKS_API_KEY MODAL_API_KEY KILO_API_KEY AGENTROUTER_API_KEY OPENGATEWAY_API_KEY CLINE_API_KEY OPENCODE_API_KEY GITHUB_TOKEN; do
  VAL="${!var}"
